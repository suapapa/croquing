...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    'review.prevPhoto': 'Previous photo',
    'review.nextPhoto': 'Next photo',
  ...
  ko: {
    ...
    'review.prevPhoto': '이전 사진',
    'review.nextPhoto': '다음 사진',
  ...
  ja: {
    ...
    'review.prevPhoto': '前の写真',
    'review.nextPhoto': '次の写真',
  ...
  pl: {
    ...
    'review.prevPhoto': 'Poprzednie zdjęcie',
    'review.nextPhoto': 'Następne zdjęcie',
  ...
  zh: {
    ...
    'review.prevPhoto': '上一张',
    'review.nextPhoto': '下一张',
