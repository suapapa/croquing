...
Current state: **WorkItems 001–010 done** (008 snapshot sync included). See [docs/progress/PROGRESS.md](docs/progress/PROGRESS.md). Next: **011** (photo selection API) or **013** (server timer).
